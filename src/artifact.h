...
enum EArtifact {
	                         ART_ARTIFACT_SPELLBOOK  = 0,
                          ART_ARTIFACT_SPELL_SCROLL  = 1,
                                 ART_ARTIFACT_GRAIL  = 2,
                              ART_ARTIFACT_CATAPULT  = 3,
                              ART_ARTIFACT_BALLISTA  = 4,
                             ART_ARTIFACT_AMMO_CART  = 5,
                        ART_ARTIFACT_FIRST_AID_TENT  = 6,
                                    ART_CENTAUR_AXE  = 7,
